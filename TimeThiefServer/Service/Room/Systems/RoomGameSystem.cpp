...
bool RoomGameSystem::Init(Room* ownerRoom, const GameDataManager& gameDataManager, const GameConfig& gameConfig)
{
   ...
   if (!zoneSystem_.Init(ownerRoom, ZoneBounds{ SE::Math::Vector3{}, SE::Math::Vector3{130740.0, 160330.0, 0.0f} }, gameDataManager_->GetZoneTable(), gameConfig.zoneDamageTickInterval))
      return false;
