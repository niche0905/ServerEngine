...
public:
   bool Init(int32 shardCount, SessionManager* sessionManager, RoomDirectory* roomDirectory, PlayerManager* playerManager, GameDataManager* gameDataManager, const GameConfig& gameConfig);
